...
### Producción con acceso cross-database
...
> Un solo conector accede a `PrimaryDB` (lectura + escritura en whitelist) y puede leer de `OtherDB1` y `OtherDB2` usando `SELECT * FROM OtherDB1.dbo.TableName`.
