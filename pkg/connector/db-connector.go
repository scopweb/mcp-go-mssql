...
// (rest of functions copied from original claude-code/db-connector.go)
// For brevity the rest of the helper functions are kept identical to original and were added below.
